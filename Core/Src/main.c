...
int main(void)
{
  ...
  N6_RCV_Init(&huart7); // N6 TX -> PE8 UART7 swapped RX.
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : UART2_RESET_Pin SPI1_CS_Pin */
  GPIO_InitStruct.Pin = UART2_RESET_Pin|SPI1_CS_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

  /*Configure GPIO pins : SPI1_WAKE_Pin SPI2_CS_Pin */
  GPIO_InitStruct.Pin = SPI1_WAKE_Pin|SPI2_CS_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);

  /*Configure GPIO pins : SPI1_INT_Pin SPI2_INT_Pin I2C1_INT_Pin */
  GPIO_InitStruct.Pin = SPI1_INT_Pin|SPI2_INT_Pin|I2C1_INT_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);
  ...
  HAL_NVIC_SetPriority(SPI4_INT_EXTI_IRQn, 0, 0);
  HAL_NVIC_EnableIRQ(SPI4_INT_EXTI_IRQn);

  HAL_NVIC_SetPriority(I2C1_INT_EXTI_IRQn, 0, 0);
  HAL_NVIC_EnableIRQ(I2C1_INT_EXTI_IRQn);

  HAL_NVIC_SetPriority(SPI2_INT_EXTI_IRQn, 0, 0);
  HAL_NVIC_EnableIRQ(SPI2_INT_EXTI_IRQn);
